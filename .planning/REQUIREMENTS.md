...
- [x] **EXPRT-02**: App compiles complete carpeta as ZIP with organized folder structure: 00_ERPI/, A_PROPUESTA/, B_PERSONAL/, C_ERPI/, D_COTIZ/, E_FINANZAS/
- [x] **EXPRT-03**: Export includes validation report, score estimate, and submission upload guide
- [x] **EXPRT-04**: Export only proceeds when all blocker validations pass — warnings are flagged but don't block
